...
Public Class Report_EMPLEADOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Academy.Report_EMPLEADOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_EMPLEADOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_EMPLEADOS = New Report_EMPLEADOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
