...
Public Class Report_ALUMNOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Academy.Report_ALUMNOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_ALUMNOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_ALUMNOS = New Report_ALUMNOS()
        rpt.Site = Me.Site
        Return rpt
    End Function
